...
class API(models.Model):
    ...
    next_update_photo_time = models.DateTimeField(verbose_name='Дата, когда обновляем фотографию')
    last_photo_id = models.CharField(max_length=64, verbose_name='ID последнего фото поьзователя')
    try_count = models.IntegerField(default=0, verbose_name='Количество попыток')
